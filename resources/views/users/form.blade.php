    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ isset($user) ? route('user.update') : route('register') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input id="student_id" type="text" class="form-control @error('student_id') is-invalid @enderror" name="student_id" value="{{ old('student_id', isset($user) ? $user->student_id : '' ) }}" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', isset($user) ? $user->name : '' ) }}" required autocomplete="name">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input id="name_yomi" type="text" class="form-control @error('name_yomi') is-invalid @enderror" name="name_yomi" value="{{ old('name_yomi', isset($user) ? $user->name_yomi : '' ) }}" required>
                    <small class="form-text text-muted">姓と名の間にはスペースを入れてください</small>
